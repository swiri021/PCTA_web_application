"""
Django settings for pcta_updated project.
...
SECRET_KEY = 'h=$o9#=)zvc_6s^z4yi$0c225@l9h_3q8kl%xydrk-)kv1rb^j'
...
ROOT_URLCONF = 'pcta_updated.urls'
...
WSGI_APPLICATION = 'pcta_updated.wsgi.application'
